    ...
    <section id="schedule" className="bg-[#F5EBD9]/50 py-20">
      <div className="mx-auto max-w-3xl px-6">
        <div className="text-center">
          ...
          <p className="mb-10 text-base text-[#1B2845]/70">
            毎週<strong className="font-semibold">木曜日</strong>(不定期)に開催しています。
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-[#C19A4A]/30 bg-white p-6 shadow-sm sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="mb-1 text-xs font-semibold tracking-wider text-[#C19A4A]">
                第1部
              </p>
          ...
          <div className="rounded-2xl border-2 border-[#C19A4A] bg-gradient-to-br from-[#FAF6EE] to-[#F5EBD9] p-6 shadow-md sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="mb-1 text-xs font-semibold tracking-wider text-[#9A7A38]">
                1部 + 2部
              </p>
              <h4 className="mb-1 text-xl font-bold text-[#1B2845]">
                通し参加
          ...
          <div className="rounded-2xl border border-dashed border-[#1B2845]/30 bg-white/70 p-6 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="mb-1 text-xs font-semibold tracking-wider text-[#1B2845]/60">
                初めての方
              </p>
              <h4 className="mb-1 text-xl font-bold text-[#1B2845]">
                体験参加
              </h4>
              <p className="text-sm text-[#1B2845]/70">まずはお試しで</p>
            </div>
